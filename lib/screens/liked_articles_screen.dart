...
class _LikedArticlesScreenState extends State<LikedArticlesScreen> {
  ...
  Future<void> _fetchLikedArticles() async {
    try {
      final articles = await _interactionService.getLikedArticles();
      setState(() {
        _articles = articles;
        _loading = false;
      });
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: const [
          Icon(Icons.favorite_outline, color: Colors.white24, size: 80),
          SizedBox(height: 16),
          Text(
            'No liked articles',
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.favorite, size: 16, color: AppColors.orange),
